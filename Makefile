...
sat_t:	test/unit_test.c	
	gcc -fmessage-length=0 -pedantic-errors -std=gnu99 -Werror -Wall -Wextra -Wwrite-strings -Winit-self -Wcast-align -Wcast-qual -Wpointer-arith -Wstrict-aliasing -Wformat=2 -Wmissing-include-dirs -Wno-unused-parameter -Wshadow -Wuninitialized -Wold-style-definition -m32 -DDEBUG test/unit_test.c test/unit_test_check_args.c test/unit_test_input_parser.c test/unit_test_solve.c -o bin/unit_test.o
